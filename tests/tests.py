...
class TestEncoding(unittest.TestCase):
    def test_encodes(self):
        self.assertEqual(encode_data(b'test'), "Appertain consignee abatable")
        self.assertEqual(encode_data(b't'), "Adsorb")

        sentence = 'Birdnest vara lobed or orthoptic. Wow fencing orthogonal yet anthropomorphic. Scranch rifadin anosmatic'
